...
from utils.normal import get_normal_vector, get_dataset_l
...
if __name__ == '__main__':
    ...
    draw_robbins_monro_line(X0, X1, akp)
    draw_robbins_monro_line(X0, X1, nsko)

    draw_beta_dependency(X0, X1, akp)
    draw_beta_dependency(X0, X1, nsko)

    draw_W_dependency(X0, X1, akp)
    draw_W_dependency(X0, X1, nsko)
